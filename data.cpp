...
cout << "Type: \"char\"; Size: " << sizeof(signed char) << " bytes; Minimum value: " << CHAR_MIN << "; Maximum value: " << CHAR_MAX << ";" << endl;
cout << "Type: \"unsigned char\"; Size: " << sizeof(unsigned char) << " bytes; Minimum value: " << 0 << "; Maximum value: " << UCHAR_MAX << ";" << endl;
cout << "Type: \"short int\"; Size: " << sizeof(signed short int) << " bytes; Minimum value: " << SHRT_MIN << "; Maximum value: " << SHRT_MAX << ";" << endl;
cout << "Type: \"unsigned short int\"; Size: " << sizeof(unsigned short int) << " bytes; Minimum value: " << 0 << "; Maximum value: " << USHRT_MAX << ";" << endl;
cout << "Type: \"int\"; Size: " << sizeof(signed int) << " bytes; Minimum value: " << INT_MIN << "; Maximum value: " << INT_MAX << ";" << endl;
cout << "Type: \"unsigned int\"; Size: " << sizeof(unsigned int) << " bytes; Minimum value: " << 0 << "; Maximum value: " << UINT_MAX << ";" << endl;
cout << "Type: \"long int\"; Size: " << sizeof(signed long int) << " bytes; Minimum value: " << LONG_MIN << "; Maximum value: " << LONG_MAX << ";" << endl;
cout << "Type: \"unsigned long int\"; Size: " << sizeof(unsigned long int) << " bytes; Minimum value: " << 0 << "; Maximum value: " << ULONG_MAX << ";" << endl;
cout << "Type: \"long long int\"; Size: " << sizeof(signed long long int) << " bytes; Minimum value: " << LLONG_MIN << "; Maximum value: " << LLONG_MAX << ";" << endl;
